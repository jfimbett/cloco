...
\[
U_M(\sigma,\phi)\;=\;\phi\,\E[A] - \eta\phi^2\,\V[A].
\]
...
The manager solves
\[
\max_\sigma \; \phi\,\E[A] - \eta\phi^2\,\V[A],
\]
...
\paragraph{``Pay for risk, not luck.''}
