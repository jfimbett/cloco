...
\begin{figure}[H]
    ...
    \fnote{\textit{Note:} Other parameters at calibration baseline: $\Sharpe=0.35$, $r_f=3.70\%$, $\gamma=5$, $\eta=3$, $A_0=1$, $f_1=1.5$. Four values of $f_2$ are shown: 5, 15, 25 (baseline), and 50.}
